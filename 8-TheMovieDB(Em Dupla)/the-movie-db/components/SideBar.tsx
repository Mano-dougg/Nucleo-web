...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose, addUser }) => {
  return (
    <div className={`fixed flex justify-center top-0 right-0 h-full bg-white shadow-lg transition-transform transform ${isOpen ? 'translate-x-0' : 'translate-x-full'} sm:w-80 w-full z-1`}>
      <div className="p-4">
