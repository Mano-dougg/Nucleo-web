...
const cadastrarFav = async (id: number, path: string, title: string) => {
    ...
    return (
        <div className='div-mae-pesquisa'>
            <div className='barra-pesquisa'>
                <form id='form-main' onSubmit={enviar}>
                    <input 
                        type='text' 
                    ...
                    />
                    <button type='submit' id='imagem-pesquisa'>
                        <Image src={lupa} alt='' />
                    </button>
                </form>
            </div>
                    ...
                    <div className='div-pesquisa'>
                        <div className="div-filme">
                            <div className="dentro-filme">
                                ...
                                <p>{dado.title}</p>
                                <Image 
                                    onClick={() => cadastrarFav(dado.id, dado.poster_path, dado.title)} 
                                    src={like} 
                                    alt="Like" 
                                    width={25} 
                                    height={25} 
