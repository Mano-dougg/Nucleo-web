...
function Footer() {
  return (
    <footer className='bg-[#3B8039] flex justify-around sm:justify-around sm:space-x-10 sm:px-10 pt-7 pb-3 mt-4'>
      <div className='sm:flex hidden space-x-10'>
        <div className='space-y-6 max-w-[180px]'>
          <h6 className='font-bold text-white text-[24px]'>
        ...
        <div className='space-y-6'>
          <h6 className='text-[24px] font-bold text-white'>
            Ajuda e suporte
          </h6>
      ...
      <div className='flex-col'>
        <div className='flex space-x-8 sm:space-x-0'>
          <div className='sm:hidden'>
            ...
            <p className='font-bold text-white text-[20px]'>BoxClothes</p>
          </div>
          <div className='max-w-[400px] space-y-6'>
            ...
            <h6 className='text-[24px] hidden sm:flex font-bold text-white'>
