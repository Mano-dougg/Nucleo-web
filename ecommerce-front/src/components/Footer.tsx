...
function Footer() {
  return (
    <footer className='bg-[#3B8039] flex justify-around md:justify-around  sm:pt-7 pt-3 pb-3 mt-4 flex-col items-center sm:items-start sm:pl-5 lg:pl-0 lg:flex-row '>
