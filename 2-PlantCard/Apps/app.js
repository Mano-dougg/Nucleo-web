...
function abreMenu(event) {
    ...
    if(ativou) { event.currentTarget.setAttribute('aria-label', '"fecha opções de compartilhamento"');
} else { event.currentTarget.setAttribute('aria-label', '"abre opções de compartilhamento"') }
}
