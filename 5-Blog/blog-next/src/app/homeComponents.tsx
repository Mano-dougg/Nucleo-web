...
type HomeClientComponentProps = {
    page: AllDocumentTypes
}
const HomeClientComponent = ({ page }:HomeClientComponentProps) => {

  const data = page.data

  const [tema, setTema] = useState('claro');
  var principalClassName = "principal-" + tema;
  var mudarModoClassName = "mudarmodo-" + tema;
  var subtituloClassName = "subtitulo-" + tema;
  var textClassName = "text-" + tema;
  var textDescriptionClassName = "text-description-" + tema;
  ...
  return (
    <main className={principalClassName}>
      ...
      <h1 className={subtituloClassName}><PrismicRichText field={page.data.title} /></h1>
