          ...
          <div className="toggleTheme">
            ...
            <div>
              <button id="theme-switch" type="button" aria-label="Toggle theme" onClick={handleClick}>
                ...
                <svg id="switch-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      {isMobile && (
        <>
          <button id="menu-switch" type="button" aria-label="Toggle menu" onClick={handleClick}>
            <MenuIcon isMenuOpen={isMenuOpen} isDarkThemed={isDarkThemed ? true : false} />
          </button>
          {isMenuOpen && (
