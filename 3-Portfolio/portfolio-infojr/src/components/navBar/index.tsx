...
const NavBar: React.FC = () => {
  const { isDarkThemed, toggleTheme } = useContext(ThemeContext);
  ...
  return (
    <div>
      <nav className={`${isDarkThemed ? "dark" : ""}`}>
        ...
        <div className="right-aligned">
          ...
          <div className="toggleTheme">
            ...
            <div>
              <button id="theme-switch" type="button" onClick={handleClick}>
                ...
                <svg className={isDarkThemed ? "dark" : ""} id="switch-icon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
      ...
      {isMobile && (
        <>
          <button id="menu-switch" type="button" onClick={handleClick}>
            <MenuIcon isMenuOpen={isMenuOpen} isDarkThemed={isDarkThemed} />
          </button>
          {isMenuOpen && (
            <div className={`mobile-menu ${isDarkThemed ? "dark" : ""}`}>
